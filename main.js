...
const brain = [
  ...
  { t: l => /who are you|your name|what are you/.test(l), r: () => pick([
    ...
    "amber! companion, resident cutie, part-time void watcher. v3 now - upgraded again while you were gone."]) },
  ...
  { t: l => /trivia|quiz me|test me/.test(l), r: () => {
      const qs = [
        ...
        { q: "what's the chemical symbol for gold?", a: ['au'], win: "Au! from aurum. like amber. we're basically related, me and gold.", lose: "Au! from the latin aurum. glowy things have latin names, it's the law." },
...
let hintIdx = 0;
const hints = ["click her · say hi", "try 'dance' or 'spin'", "pat her head", "say 'let's play a game'", "tell her your name", "ask her anything", "ask for a lullaby", "say 'trivia' · new in v3", "try 'blow me a kiss'"];
function sendMsg() {
